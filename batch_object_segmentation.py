...
v_list = ["visdrone/videos/vis_%d" % i for i in [169, 170, 172, 173]]
...
for v, qp, conv in product(v_list, qp_list, conv_list):
    ...
    orig = f"{v}_compressed_blackgen_obj_conv_{conv}.mp4"
    ...
    if dual:
        ...
        output = f"{v}_compressed_blackgen_dual_obj_qp_{qp}_cv_{conv}.mp4"
